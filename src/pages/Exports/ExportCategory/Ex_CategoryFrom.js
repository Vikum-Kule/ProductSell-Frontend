...
import { getAllCategories, checkCategory, addNewCategory} from '../../../services/Export';
...
function Ex_CategoryForm({setOpenForm}) {
    ...
    return (
            <Grid container spacing={2}>
                <Grid item xs={12} sm={11} sx={12}>
                    <Typography mt={1} variant="h6"> Add Export Category </Typography>
                </Grid>
                ...
                <Grid item xs={12} sm={9} sx={12}>
                    <AutoCompleteFeild 
                        _key="category"
                        name="_exportMCategory"
                        value={values._exportMCategory} 
                        dataSet={categories}
                        label="Main Category"
                        onClick={loadCategories} 
                        errorMsg={error._exportMCategory}
...
export default Ex_CategoryForm
